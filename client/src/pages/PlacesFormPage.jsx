...
export default function PlacesFormPage() {
    ...
    try {
      if (!title || !address || !addedPhotos.length || !description || perks.length === 0 || !checkIn || !checkOut || !maxGuests || !price) {
        ...
        if (id) {
          ...
          await axios.put(`${import.meta.env.VITE_BACKEND_URL}/places`, {
            id, ...placeData
          });
          setRedirect(true);
        }else{
          // Crear un nuevo lugar
          await axios.post(`${import.meta.env.VITE_BACKEND_URL}/places`, placeData);
          setRedirect(true);
        }
  ...
  async function deletePlace() {
        await axios.delete(`${import.meta.env.VITE_BACKEND_URL}/places/${id}`);
